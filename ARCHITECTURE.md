...
- `starting/starter.js` handles discovery/rooting and deploys the sibling `early-worker.js` (with `/starting` fallbacks) across rooted hosts; repo also includes `/starter/*` compatibility copies for users running that path.
